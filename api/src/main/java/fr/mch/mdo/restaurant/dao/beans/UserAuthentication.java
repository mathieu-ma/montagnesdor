...
/**
 * This class is used for t_user_authentication mapping.
 * This table is used for user authentication.
 * 
...
public class UserAuthentication extends MdoDaoBean implements IAuthenticationPasswordLevel
{
	...
	return "UserAuthentication [levelPass1=" + levelPass1 + ", levelPass2="
		+ levelPass2 + ", levelPass3=" + levelPass3 + ", locales="
		+ locales + ", login=" + login + ", password=" + password
		+ ", printingLocale=" + printingLocale + ", restaurant="
		+ restaurant + ", user=" + user + ", userRole=" + userRole
