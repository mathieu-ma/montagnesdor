...
INSERT INTO t_product_special_code (res_id, psc_short_code, psc_code_enm_id, vat_id, psc_deleted) SELECT t_restaurant.res_id, '', t_enum.enm_id, null, false FROM t_restaurant, t_enum WHERE t_restaurant.res_reference = '10203040506070' AND t_enum.enm_language_key_label='PRODUCT_SPECIAL_CODE.DEFAULT.0';
INSERT INTO t_product_special_code (res_id, psc_short_code, psc_code_enm_id, vat_id, psc_deleted) SELECT t_restaurant.res_id, '#', t_enum.enm_id, 1, false FROM t_restaurant, t_enum WHERE t_restaurant.res_reference = '10203040506070' AND t_enum.enm_language_key_label='PRODUCT_SPECIAL_CODE.OFFERED_PRODUCT.1';
INSERT INTO t_product_special_code (res_id, psc_short_code, psc_code_enm_id, vat_id, psc_deleted) SELECT t_restaurant.res_id, '-', t_enum.enm_id, 1, false FROM t_restaurant, t_enum WHERE t_restaurant.res_reference = '10203040506070' AND t_enum.enm_language_key_label='PRODUCT_SPECIAL_CODE.DISCOUNT_ORDER.2';
INSERT INTO t_product_special_code (res_id, psc_short_code, psc_code_enm_id, vat_id, psc_deleted) SELECT t_restaurant.res_id, '/', t_enum.enm_id, 1, false FROM t_restaurant, t_enum WHERE t_restaurant.res_reference = '10203040506070' AND t_enum.enm_language_key_label='PRODUCT_SPECIAL_CODE.USER_ORDER.3';
INSERT INTO t_product_special_code (res_id, psc_short_code, psc_code_enm_id, vat_id, psc_deleted) SELECT t_restaurant.res_id, '@', t_enum.enm_id, null, false FROM t_restaurant, t_enum WHERE t_restaurant.res_reference = '10203040506070' AND t_enum.enm_language_key_label='PRODUCT_SPECIAL_CODE.CREDIT.4';
