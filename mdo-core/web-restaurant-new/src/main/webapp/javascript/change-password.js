$(document).ready(function() {
	...
	var jPassword = $(":password",$("form#ChangePassword")).keyup(function(eventParam) {
	...
	var jSubmitPassword = $("#submit").click(function(eventParam) {
		...
		function checkRequired() {
			...
			$(":password", $("form#ChangePassword")).each(function(i) {
				if(this.value=="") {
		...
		function displayMessages(displayedMessagesIndexes) {
			$("#displayed-messages li", $("form#ChangePassword")).each(function(i) {
					$("#displayed-message-"+i).css("visibility", "hidden");
			});
			jQuery.each(displayedMessagesIndexes, function(index, value) {
