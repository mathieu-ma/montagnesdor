 ...
 * 
 */
public abstract class MdoIocBasicTestCase extends MdoLoadingDatabaseTestCase //TestCase //MdoLoadingDatabaseTestCase 
{
	 ...
	 */
	public MdoIocBasicTestCase(String testName) {
		super(testName);
	}
