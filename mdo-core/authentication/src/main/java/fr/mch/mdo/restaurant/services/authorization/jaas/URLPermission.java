...
public final class URLPermission extends BasicPermission implements Serializable
{
     ...
     */
    private static final long serialVersionUID = -9169439454066563567L;
    ...
    /**
     * Creates a new FilePermission object with the specified actions. <i>path</i>
     ...
     * directory. Possible actions are "read", "write", "execute", and "delete".
     * 
     * <p>
     ...
     * indicates a directory and (recursively) all files and subdirectories
     * contained in that directory. The special pathname "&lt;&lt;ALL
...
final class URLPermissionCollection extends PermissionCollection implements Serializable
{
     ...
     *                    if this FilePermissionCollection object has been
     *                    marked readonly
     */
	...
	permissions.addElement((URLPermission) permission);
    }
