...
/**
 * This class is used for t_product_category mapping. 
 * This table is used for product depending on the specific categories.
 * 
...
public class ProductCategory extends MdoDaoBean 
{
     ...
     * This field and the other cat_id field consist of a unique field.
     */
    private Product product;
    /**
     * This is a foreign key that refers to t_category.
     * It is used to specify the category of the product.
     * This field and the other pdt_id field consist of a unique field.
     */
    private Category category;
    /**
     * This is the quantity of the category for the product.
     * For example, if the category is FISH then the quantity is the quantity of fish for this product.
     * This can be used for stock management.
     */
...
//	}
	...
	return "ProductCategory [category=" + category
		+ ", quantity=" + quantity + ", deleted=" + deleted + ", id="
		+ id + "]";
    }
