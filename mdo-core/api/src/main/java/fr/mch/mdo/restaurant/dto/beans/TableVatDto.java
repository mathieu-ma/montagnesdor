 ...
 * and values of dinner table depending on the Value Added Tax.
 * 
...
public class TableVatDto extends MdoDtoBean
{
	 ...
	 * of 5.5, then the amount is the sum of the amount of dinner table order
	 * lines with the specific Value Added Tax rate 5.5.
	 */
	private BigDecimal amount;
	/**
	 * This is the value of the dinner table depending on the specific Value
	 * Added Tax. If the Value Added Tax rate is 19.6 then the value is equals
	 * to tvt_amount*19.6./(19.6+100).
	 */
