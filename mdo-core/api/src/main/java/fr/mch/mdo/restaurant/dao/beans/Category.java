...
/**
 * This class is used for t_category mapping. 
 * This table is used for product category.
 * 
 * @author Mathieu MA sous conrad
 */
public class Category extends MdoDaoBean 
{
    /**
     ...
     * It is used to specify the product category code like MEAT, FISH ...
     */
	...
	return "Category [code=" + code + ", labels=" + labels + ", deleted="
		+ deleted + ", id=" + id + "]";
    }
}
