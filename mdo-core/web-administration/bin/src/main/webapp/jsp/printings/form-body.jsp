...
<s:form action="PrintingInformationsManagerCUD" method="post" validate="false">
		<s:hidden name="form.dtoBean.id"/>

		<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
			<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
				<li class="ui-state-default ui-corner-top"><a class="a-tabs" href="#tabs-1"><span><fmt:message key="printing.informations.manager.tab.printing.informations"/></span></a></li>
				<li class="ui-state-default ui-corner-top"><a class="a-tabs" href="#tabs-2"><span><fmt:message key="printing.informations.manager.tab.labels"/></span></a></li>
			</ul>
		    <div class="tab-contents" style="height: 25em;">
				<div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
					<div class="mdo-upsidedown-1">
						<jsp:include page="printing-informations-tab.jsp" />
				...
				<div id="tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
					<div class="mdo-upsidedown-2">
						...
						<s:if test="%{form.dtoBean.restaurant.id!='' && form.viewBean.restaurants.contains(form.dtoBean.restaurant)}">
							<s:set name="backUrlMethod" value="%{'listPrintingInformations'}"/>
						</s:if>
						...
						<s:url id="backUrl" action="PrintingInformationsManager" method="%{backUrlMethod}"  escapeAmp='false'>
						...
						<jsp:include page="../commons/crud-list.jsp">
							...
							<jsp:param name="action" value="PrintingInformationsManager"/>
							<jsp:param name="labelSelectList" value="printing.informations.manager.language"/>
							...
							<jsp:param name="labelData" value="printing.informations.manager.label"/>
