...
public class PrintingInformationsManagerWebAction extends AdministrationManagerLabelsAction 
{
	...
	public PrintingInformationsManagerWebAction() {
		super(WebAdministractionBeanFactory.getInstance().getLogger(PrintingInformationsManagerWebAction.class.getName()), new PrintingInformationsManagerForm());
		administrationManager = WebAdministractionBeanFactory.getInstance().getPrintingInformationsManager();
		setRestaurantsManager(WebAdministractionBeanFactory.getInstance().getRestaurantsManager());
	}
