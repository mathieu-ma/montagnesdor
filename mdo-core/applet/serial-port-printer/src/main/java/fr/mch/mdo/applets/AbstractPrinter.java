 ...
 * @version
 */
public abstract class AbstractPrinter implements Serializable
{
	/**
	...
	public void init() {
		...
		if (driver == null) {
			debug = Boolean.TRUE.toString().equalsIgnoreCase(this.getParameter(AbstractPrinter.APPLET_PARAMETER_DEBUG_KEY, Boolean.FALSE.toString()));

			charset = this.getParameter(AbstractPrinter.APPLET_PARAMETER_CHARSET_KEY, AbstractPrinter.DEFAULT_CHARSET);
			String specialCharactersString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_SPECIAL_CHARACTERS_STRING_KEY, AbstractPrinter.DEFAULT_SPECIAL_CHARACTERS_STRING);
			StringTokenizer specialCharactersStk = new StringTokenizer(specialCharactersString, ";");
			String bindSpecialCharactersString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_BIND_SPECIAL_CHARACTERS_STRING_KEY, AbstractPrinter.DEFAULT_BIND_SPECIAL_CHARACTERS_STRING);
			...
			String driverName = AbstractPrinter.DEFAULT_WINDOWS_DRIVER_NAME;
			String portCom = AbstractPrinter.DEFAULT_WINDOWS_PORT_COM;
			try {
				if (os.toLowerCase().matches("linux")) {
					driverName = this.getParameter(AbstractPrinter.APPLET_PARAMETER_LINUX_DRIVER_NAME_KEY, AbstractPrinter.DEFAULT_LINUX_DRIVER_NAME);
					portCom = this.getParameter(AbstractPrinter.APPLET_PARAMETER_LINUX_PORT_COM_KEY, AbstractPrinter.DEFAULT_LINUX_PORT_COM);
				} else {
					driverName = this.getParameter(AbstractPrinter.APPLET_PARAMETER_WINDOWS_DRIVER_NAME_KEY, AbstractPrinter.DEFAULT_WINDOWS_DRIVER_NAME);
					portCom = this.getParameter(AbstractPrinter.APPLET_PARAMETER_WINDOWS_PORT_COM_KEY, AbstractPrinter.DEFAULT_WINDOWS_PORT_COM);
				}
				String serialportBaudsString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_SERIAL_PORT_BAUDS_KEY, AbstractPrinter.DEFAULT_SERIAL_PORT_BAUDS);
				serialportBauds = Integer.parseInt(serialportBaudsString);
				String serialportBitsString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_SERIAL_PORT_BITS_KEY, AbstractPrinter.DEFAULT_SERIAL_PORT_BITS);
				serialportBits = Integer.parseInt(serialportBitsString);
				String serialportStopBitsString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_SERIAL_PORT_STOP_BITS_KEY, AbstractPrinter.DEFAULT_SERIAL_PORT_STOP_BITS);
				serialportStopBits = Integer.parseInt(serialportStopBitsString);
				String serialportParityString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_SERIAL_PORT_PARITY_KEY, AbstractPrinter.DEFAULT_SERIAL_PORT_PARITY);
				serialportParity = Integer.parseInt(serialportParityString);
				String packetString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_PACKET_KEY, AbstractPrinter.DEFAULT_PACKET);
				packet = Integer.parseInt(packetString);
				String pauseString = this.getParameter(AbstractPrinter.APPLET_PARAMETER_PAUSE_KEY, AbstractPrinter.DEFAULT_PAUSE);
	...
	public void print() {
		...
		byte[] dataPlusCutPaper = new byte[dataBytes.length + AbstractPrinter.PRINT_FEED_PAPER_CUT_SHEET.length];
		System.arraycopy(dataBytes, 0, dataPlusCutPaper, 0, dataBytes.length);
		System.arraycopy(PRINT_FEED_PAPER_CUT_SHEET, 0, dataPlusCutPaper, dataBytes.length, AbstractPrinter.PRINT_FEED_PAPER_CUT_SHEET.length);
